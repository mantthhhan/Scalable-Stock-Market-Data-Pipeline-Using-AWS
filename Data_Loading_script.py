...
if __name__ == "__main__":
    ...
    bucket_name = os.getenv("S3_BUCKET", "finance-stock-data-manthan")  # S3 bucket name
    symbols = os.getenv("STOCK_SYMBOLS", "AAPL,SOFI,NVDA").split(",")  # Stock symbols
    try:
        # Fetch API key from AWS Secrets Manager
        secrets = fetch_secret(secret_name)
        api_key = secrets['yahoo_fin_api_key']
