...
if __name__ == "__main__":
    ...
    raw_bucket = os.getenv("RAW_BUCKET", "finance-stock-data-manthan")  # Raw data S3 bucket
    transformed_bucket = os.getenv("TRANSFORMED_BUCKET", "finance-stock-data-manthan")  # Transformed data S3 bucket
